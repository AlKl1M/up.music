    ...
    <div class="hero-body">
        <div class="constainer">
            <div class="columns is-centered">
                <div class="column in-5-tablet is-4-desktop is-3-widescreen">
                    ...
                    <h3 class="label"><?= GetMessage("AUTH_PLEASE_AUTH") ?></h3>
                    ...
                    <form class="box" name="form_auth" method="post" target="_top" action="<?= $arResult["AUTH_URL"] ?>">
                        ...
                        <? endif ?>
                        <div class="bx-authform-formgroup-container">
                            <input type="submit" class="button is-success" name="Login"
